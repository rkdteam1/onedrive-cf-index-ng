...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'rkd_iptvott@malayaacxO1.my.id',
  ...
  baseDirectory: process.env.BASE_DIRECTORY || '/Pub1ic',
  ...
  footer:
    'Powered by RKDTeam. Made with ❤ by RKDTeam.',
